...
public class ExchangeHealerRenderer implements BlockEntityRenderer<ExchangeHealerBlockEntity> {
    private final ItemRenderer itemRenderer;
    private final Font font;
    private int lightAtPos = 0xF000F0; // 最大限に明るい光源値

    public ExchangeHealerRenderer(BlockEntityRendererProvider.Context context) {
        this.itemRenderer = context.getItemRenderer();
        this.font = context.getFont();
    }

    @Override
    public void render(ExchangeHealerBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        // アイテムを描画
    ...
    private void renderItem(ExchangeHealerBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedOverlay) {
        poseStack.pushPose();
