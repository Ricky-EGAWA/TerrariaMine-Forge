...
public class ExchangeOrePickaxeRenderer implements BlockEntityRenderer<ExchangeOrePickaxeBlockEntity> {
    ...
    public void render(ExchangeOrePickaxeBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        // アイテムを描画
        renderItem(blockEntity, partialTicks, poseStack, bufferSource, packedLight, packedOverlay);

        // 文字を描画
        renderText(blockEntity, poseStack, bufferSource, packedLight);
    }

    private void renderItem(ExchangeOrePickaxeBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        poseStack.pushPose();
    ...
    private void renderText(ExchangeOrePickaxeBlockEntity blockEntity, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        poseStack.pushPose();
