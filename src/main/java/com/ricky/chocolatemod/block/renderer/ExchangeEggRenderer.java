...
import com.ricky.chocolatemod.block.entity.ExchangeEggBlockEntity;
...
public class ExchangeEggRenderer implements BlockEntityRenderer<ExchangeEggBlockEntity> {
    private final ItemRenderer itemRenderer;
    private final Font font;
    private int lightAtPos = 0xF000F0; // 最大限に明るい光源値

    public ExchangeEggRenderer(BlockEntityRendererProvider.Context context) {
        this.itemRenderer = context.getItemRenderer();
        this.font = context.getFont();
    }

    @Override
    public void render(ExchangeEggBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        // アイテムを描画
    ...
    private void renderItem(ExchangeEggBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedOverlay) {
        poseStack.pushPose();
        ...
        // アイテムを描画
        ItemStack itemStack = new ItemStack(ModItems.GOLDEN_EGG.get());
